...
SELECT titulo, autor FROM dblink('dbname = biblioteca port = 5432','SELECT titulo, autor FROM libros') 
...
INNER JOIN (SELECT id_libros ,titulo,autor FROM dblink('dbname = biblioteca port = 5432',
